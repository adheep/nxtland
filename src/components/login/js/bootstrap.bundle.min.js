...
!function (t, e) {
    ...
    var _ = "button",
        ...
        k = function () {
            ...
            return t.toggle = function () {
                ...
                e && this
                    ._element
                    .setAttribute("aria-pressed", !this._element.classList.contains(w)),
    ...
    var L = "carousel",
        ...
        at = function () {
            ...
            t.pause = function (t) {
                ...
                this
                    ._element
                    .querySelector(nt) && (m.triggerTransitionEnd(this._element), this.cycle(!0)),
            ...
            t._setActiveIndicatorElement = function (t) {
                if (this._indicatorsElement) {
                    var e = []
                        .slice
                        .call(this._indicatorsElement.querySelectorAll(J));
                    p(e).removeClass(Q);
    ...
    var lt = "collapse",
        ...
        Ct = function () {
            function a(e, t) {
                ...
                this._triggerArray = []
                    .slice
                    .call(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
            ...
            t.show = function () {
                ...
                if (!this._isTransitioning && !p(this._element).hasClass(mt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(bt)).filter(function (t) {
                    ...
                    if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        this._triggerArray.length && p(this._triggerArray)
                            .removeClass(vt)
            ...
            a._jQueryInterface = function (i) {
                return this.each(function () {
                    var t = p(this),
                        e = t.data(ct),
                        n = l({}, ft, t.data(), "object" == typeof i && i
                            ? i
                            : {});
    ...
    function jt(t) {
        ...
        for (var e = Ht(10)
            ? document.body
            : null, n = t.offsetParent || null; n === e && t.nextElementSibling;) 
    ...
    function Ut(t, e, n, i) {
        return Math.max(e["offset" + t], e["scroll" + t], n["client" + t], n["offset" + t], n["scroll" + t], Ht(10)
            ? parseInt(n["offset" + t]) + parseInt(i["margin" + ("Height" === t
                    ? "Top"
                    : "Left")]) + parseInt(i["margin" + ("Height" === t
                    ? "Bottom"
                    : "Right")])
            : 0)
    }
    ...
    function zt(t, e) {
        ...
        return (i && !n
            ? e.contains(a)
            : e === a && "BODY" !== a.nodeName) && (u = function (t, e) {
            var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
                i = Mt(e, "top"),
                o = Mt(e, "left"),
                r = n
                        ...
                        if (0 !== s.indexOf("%")) 
                            return "vh" !== s && "vw" !== s
                                ...
                                : ("vh" === s
                                    ...
                                    : Math.max(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * r;
                        var a = void 0;
                        switch (s) {
                            case "%p":
                                a = n;
            ...
            modifiers: {
                            ...
                            u = {
                                ...
                                secondary: function (t) {
                                    var e = "right" === t
                                            ...
                                            : "top",
                                        n = h[e];
                                    return h[t] > l[t] && !i.escapeWithReference && (n = Math.min(h[e], l[t] - ("right" === t
                                        ? h.width
                                        : h.height))),
                                    Kt({}, e, n)
                                }
                ...
                flip: {
                    ...
                    fn: function (p, m) {
                        ...
                        return E.forEach(function (t, e) {
                            ...
                            (s || u || d) && (p.flipped = !0, (s || u) && (_ = E[e + 1]), d && (y = "end" === (n = y)
                                ? "start"
                                : "start" === n
                                    ? "end"
                                    : n), p.placement = _ + (y
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        ...
                        void 0 !== r && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not " +
                ...
                applyStyle: {
                    ...
                    fn: function (t) {
                        ...
                        t.arrowElement && Object
                            .keys(t.arrowStyles)
                            .length && he(t.arrowElement, t.arrowStyles),
                        t
                    },
        ...
        be = function () {
            function r(t, e) {
                ...
                Object.keys(Qt({}, r.Defaults.modifiers, i.modifiers))
                    .forEach(function (t) {
                        n.options.modifiers[t] = Qt({}, r.Defaults.modifiers[t] || {}, i.modifiers
                            ? i.modifiers[t]
                            : {})
                    }),
        ...
        Xe = function () {
                ...
                if (!this._element.disabled && !p(this._element).hasClass(Oe)) {
                    ...
                    if (c._clearMenus(), !e) {
                        ...
                        if (p(t).trigger(i), !i.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === p(t)
                                .closest(Me)
                                .length && p(document.body)
                                .children()
            ...
            c._jQueryInterface = function (e) {
                return this.each(function () {
                    ...
                    if (t || (t = new c(this, "object" == typeof e
                        ? e
                        : null), p(this).data(Ce, t)), "string" == typeof e) {
            ...
            c._dataApiKeydownHandler = function (t) {
                if ((/input|textarea/i.test(t.target.tagName)
                    ...
                    : Ie.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(Oe))) {
                    var e = c._getParentFromElement(this),
                        n = p(e).hasClass(Ne);
                    if (n && (!n || 27 !== t.which && 32 !== t.which)) {
                        var i = []
                            .slice
                            .call(e.querySelectorAll(We));
                        if (0 !== i.length) {
        ...
        gn = function () {
            ...
            t.show = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(nn.CLICK_DISMISS, dn, function (t) {
                        ...
                        p(e._element)
                            .one(nn.MOUSEUP_DISMISS, function (t) {
            ...
            t._enforceFocus = function () {
                ...
                p(document)
                    ...
                    .on(nn.FOCUSIN, function (t) {
                        document !== t.target && e._element !== t.target && 0 === p(e._element)
                            .has(t.target)
                            .length && e
                            ._element
                            .focus()
            ...
            t._setScrollbar = function () {
                ...
                if (this._isBodyOverflowing) {
                    var t = []
                            .slice
                            .call(document.querySelectorAll(pn)),
                        e = []
                            .slice
                            .call(document.querySelectorAll(mn));
            ...
            o._jQueryInterface = function (n, i) {
                return this.each(function () {
                    var t = p(this).data($e),
                        e = l({}, tn, p(this).data(), "object" == typeof n && n
                            ? n
                            : {});
        ...
        qn = function () {
            ...
            t.show = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    p(o).addClass(jn),
                    "ontouchstart" in document.documentElement && p(document.body)
                        .children()
                        .on("mouseover", null, p.noop);
                    var c = function () {
            ...
            t.hide = function (t) {
                var e = this,
                    ...
                    o = function () {
                        e._hoverState !== Ln && n.parentNode && n
                            .parentNode
                            .removeChild(n),
                        e._cleanTipClass(),
                        e
            ...
            t._enter = function (t, e) {
                ...
                p(e.getTipElement()).hasClass(jn) || e._hoverState === Ln
                    ? e._hoverState = Ln
                    : (clearTimeout(e._timeout), e._hoverState = Ln, e.config.delay && e.config.delay.show
            ...
            t._leave = function (t, e) {
                ...
                t && (e._activeTrigger["focusout" === t.type
                        ? Wn
                        : Mn] = !1),
                e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = xn, e.config.delay && e.config.delay.hide
                    ? e._timeout = setTimeout(function () {
    ...
    var oi = "scrollspy",
        ...
        Ci = function () {
            ...
            t._getConfig = function (t) {
                if ("string" != typeof(t = l({}, li, "object" == typeof t && t
                    ? t
                    : {})).target) {
            ...
            t._activate = function (e) {
                ...
                n.hasClass(ui)
                    ...
                    : (n.addClass(fi), n.parents(pi).prev(mi + ", " + _i).addClass(fi), n.parents(pi).prev(gi).children(mi).addClass(fi)),
        ...
        Zi = function () {
            ...
            t.hide = function (t) {
                ...
                this
                    ._element
                    .classList
                    .contains(zi) && (p(this._element).trigger(Qi.HIDE), t
                    ? this._close()
            ...
            t._getConfig = function (t) {
                return t = l({}, $i, p(this._element).data(), "object" == typeof t && t
                    ? t
                    : {}),
